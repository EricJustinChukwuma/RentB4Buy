...
<body>
            ...
            <div class="navbar">
                ...
                ?>
                    <div class="user-menu-container">
                        ...
                        <h3>Hi, <?= htmlspecialchars($_SESSION["user_firstname"]) . " " . htmlspecialchars($_SESSION["user_lastname"])?></h3>
                    </div>
                <?php endif; ?>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($cartItems as $item): 
                                ...
                                $totalCost += $itemTotal; // Sets cart total price 
                                $_SESSION['cart-total-price'] = $totalCost; // store cart total in a session
    ...
    <script>
        ...
        function removeItem(productId) {
            // runs a post request whenever the button is clicked and sends the  necessary information to the php file to handle the process
            fetch("../includes/update_cart.php", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
