...
<body>
    ...
    <div class="edit-product-main">
        ...
        <form method="post">
            ...
            <textarea name="description" rows="4" required><?= htmlspecialchars($product['description']) ?></textarea><br>

            <label>Price:</label><br>
            <input type="number" name="price" step="0.01" value="<?= htmlspecialchars($product['price']) ?>" required><br>

            <label>Price Per Day:</label><br>
            <input type="number" name="price_per_day" step="0.01" value="<?= htmlspecialchars($product['price_per_day']) ?>" required><br>

            <label>Available Quantity:</label><br>
            <input type="number" name="available_qty" value="<?= htmlspecialchars($product['available_qty']) ?>" required><br>

            <label>Product Image URL:</label><br>
            <input type="text" name="product_image" value="<?= htmlspecialchars($product['product_image']) ?>" required><br>
