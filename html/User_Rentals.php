...
// Feecthes a user id when admin clicks view rentals for a particular user
// user id is passed via a GET request method
$userId = $_GET['user_id'] ?? null;

// chekcs if the variable userId does not exist 
if (!$userId) {
    die("User ID missing.");
};
...
// Fetch rental history of user matching the userId passed in the GET request
...
<head>
    ...
    <link rel="stylesheet" href="../css/User_Rentals.css">
</head>
<body>
    ...
    <main class="user-rentals-conatiner">
                ...
                <?php if ($rentals): ?>
                    <?php foreach ($rentals as $rental): ?>
                        <tr>
                            ...
                            <td><?= ucfirst($rental['rent_status']) // converts the first letter to uppercase?></td>
                            <td>£<?= number_format($rental['total_price'], 2) // Format a number with grouped thousands?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
