...
$sql = "SELECT id, username, email, created_at FROM users WHERE role_id = 2 ORDER BY created_at ASC";
$stmt = $pdo->query($sql);
...
<head>
    ...
    <style>
        ...
        .user-info-section table thead tr th {
            padding: 30px 20px;
        }

        .user-info-section table tbody tr td {
            padding: 30px 20px;
            text-align: center;
        }

        .user-info-section table tbody tr td a {
