...
<body>
    ...
    <!--------- TO BE ADDED TO THE PROFILE PAGE AND DISPLAYED IF AN ADMIN IS LOGGED IN ----------->
        ...
        <?php if (isset($_SESSION['user_id']) && isset($_SESSION['user_role_id']) && $_SESSION['user_role_id'] == 1) { ?>
            ...
            <div class="profile-info-settings">
                ...
                <div class="info-setting">
                    ...
                    <a href="update_products.php" class="card-setting">Manage card payment</a>
                </div>
            </div>
            ...
            <div class="view-rentals-section">
                ...
                <div class="view-rentals">
                    ...
                    <p>View all your rentals since being a part of us. Take a look at all you've rented and you just might fancy one of them again</p>
